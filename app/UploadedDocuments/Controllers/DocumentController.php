...
final class DocumentController extends AuthenticatedController
{
     ...
     */
    #[ScrambleResponse(200, 'Document metadata and processing results', examples: [['uuid' => '9d3f8a2b-1c4e-4f5a-b6d7-8e9f0a1b2c3d', 'file_size_bytes' => 1024, 'mime_type' => 'application/pdf', 'processed_at' => null, 'created_at' => '2025-02-16T12:00:00.000000Z', 'updated_at' => '2025-02-16T12:00:00.000000Z', 'status' => 'pending', 'error_message' => null, 'job_status' => 'pending', 'parsed_result' => null, 'anonymised_result' => null, 'anonymised_artifacts' => null, 'normalized_result' => null, 'transliteration_mapping' => null, 'final_result' => null]])]
    ...
    /**
     * Deletes document and related processing data for the owner.
     */
    public function destroy(string $uuid): JsonResponse
    {
        $deleted = $this->documentService->deleteByUuid($uuid);
        if (! $deleted) {
            abort(Response::HTTP_NOT_FOUND);
        }
